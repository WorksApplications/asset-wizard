        ...
        return(
            <div>
                ...
                >
                    ...
                    <Divider />
                    <div>
                        <ListItem className={classes.nested} button onClick={this.handleAssetManagementClick}>
                            <ListItemIcon>
                                <Store />
                            </ListItemIcon>
                        ...
                        <Collapse in={this.state.assetMenuOpen} timeout="auto" unmountOnExit>
                    ...
                    <Divider />
                    <div>
                        <ListItem className={classes.nested} button onClick={this.handleAllocationManagementClick}>
                            <ListItemIcon>
                                <Store />
                            </ListItemIcon>
                        ...
                        <Collapse in={this.state.allocationMenuOpen} timeout="auto" unmountOnExit>
                            <List component="div" disablePadding>
                                <ListItem button className={classes.nested}>
                                        <ListItemIcon>
                                            <Store />
