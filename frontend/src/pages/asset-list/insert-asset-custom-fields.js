...
class InsertAssetCustomFields extends React.Component {
    ...
    handleDelete = (key) =>{
        const newDatas = this.state.customFieldData.filter((s, sidx) => key != sidx);
    ...
    createCustomField = () =>{
        ...
        this.setState({customFieldData: this.state.customFieldData.concat([{
        ...
        return(
            <div className={classes.customFieldContainer}>
                <div className={classes.customFieldButton}>
                    <Button className={classes.button} onClick={this.createCustomField}>Add Custom Field</Button>
                </div>
                <div id="customFields">
                    {this.state.customFieldData.map((customData, idx) => (
                        <AssetCustomField key={idx} uniqueId={idx} 
